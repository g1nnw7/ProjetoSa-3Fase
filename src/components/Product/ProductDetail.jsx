...
// --- Ícones (Sugestão para a Info Nutricional) ---
// Ícone de Fogo (Calorias)
function FireIcon() {
...
export default function ProductDetails({ product, onCloseAfterAdd }) {
  ...
  const handleAddToCart = () => {
    addToCart(product);
    onCloseAfterAdd(); // Fecha o modal depois de adicionar
  };

  return (
    // Note que não há 'overlay' ou 'div' de fundo, 
    // apenas o layout do conteúdo (imagem + info).
      ...
      <div className="w-full md:w-1/2 p-6 flex flex-col justify-between overflow-y-auto">
        <div>
          ...
          <p className="text-gray-700 mt-4 text-base">
            {product.descricao} {/* Descrição completa */}
          </p>
